<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="GestorVS2012.RegisterExternalLogin" %>
    ...
    <asp:PlaceHolder runat="server" ID="userNameForm">
        <fieldset>
            ...
            <p>
                ...
                <strong><%: ProviderUserName %></strong>.Por favor ingrese nombre de usuario en el siguiente formulario
